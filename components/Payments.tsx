...
import { getClients, getInvoices, getClientFinancials, getTransactions, getContracts, getBillboards, addInvoice, markInvoiceAsPaid, getUpcomingBillings, deleteInvoice, pullAllDataFromSupabase } from '../services/mockData';
import { generateStatementPDF, generatePaymentSchedulePDF } from '../services/pdfGenerator';
import { Client, Invoice } from '../types';
import { DollarSign, FileText, Download, CheckCircle, AlertCircle, Search, CreditCard, X, Check, Filter, Hash, Wallet, Building, Clock, Calendar, Trash2, RefreshCw } from 'lucide-react';
